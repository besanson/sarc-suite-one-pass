...
| Formal max compensated response profiles: 48 / 98 | exhaustive discrete grid, not seed-sampled |
| Empirical max compensated held decision instances, pooled S1-S4 | 13775.1 (95% CI [13753.5, 13796.6], n=30) |
...
Version 0.4 revises framing, positioning, and related-work coverage following a commissioned second review (review-secondary/), with all measured results, claim semantics, PROOF-STATUS tags, and the four-round review chain unchanged. Versions 0.1 to 0.3 remain recoverable as immutable historical revisions in repository history.
